...
Current branch: `main`
Current PRs: #1 and follow-up #6 — both merged
Last verified implementation head: `af4b7c38182b1fd998918791ad3c07669f803ba4`
Last verified post-merge CI run: `34626301398` — Node 22 and Node 24 both green, including frozen install, `pnpm check`, packed-package consumer import, and clean git status.
